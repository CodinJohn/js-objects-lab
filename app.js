...
console.log('Excercise 3',game.difficulty)
...
console.log('Excercise 6',game.party)
...
console.log('Excersise 7', game.gyms)
...
pokemon.forEach(pokemon => {
    if(pokemon.starter === true){
        console.log('Excerise 10',pokemon.name)
    }
})
...
//Could not figure out how to make this work struggled with 11, 12, 14,
...
console.log('Excersise 13', game.gyms)
...
console.log('Excersise 16', game.gyms)
